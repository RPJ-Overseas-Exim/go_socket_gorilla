...
func Login() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"bg-muted\"><form id=\"login-form\" hx-post=\"/login\" class=\"w-1/2 mx-auto\"><p><label for=\"username\">Username: </label> <input type=\"text\" name=\"username\" id=\"username\"></p><p><label for=\"password\">Password: </label> <input type=\"text\" name=\"password\" id=\"password\"></p><button type=\"submit\">Submit</button></form></div>")
			if templ_7745c5c3_Err != nil {
